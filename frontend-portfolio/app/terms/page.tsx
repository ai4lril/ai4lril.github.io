...
export default function TermsPage() {
    return (
        <div className="container mx-auto py-12 px-4 max-w-3xl animate-fade-in-up">
            <div className="neu-raised rounded-2xl p-6 md:p-8 animate-bounce-in">
                ...
                <details className="mt-8 neu-raised rounded-xl p-4" id="eligibility">
                ...
                <details className="mt-8 neu-raised rounded-xl p-4" id="contributions">
                    <summary className="font-semibold text-slate-800 cursor-pointer pb-2 flex items-center gap-3">
                ...
                <section className="mt-8 neu-raised rounded-2xl p-4">
                ...
                <section className="mt-10">
                    ...
                    <details className="mt-8 neu-raised rounded-xl p-4" id="community">
                        <summary className="font-semibold text-slate-800 cursor-pointer pb-2 flex items-center gap-3">
                        ...
                        <div className="mt-3">
                            ...
                            <ul className="mt-3 list-disc ml-6 space-y-2 text-slate-700">
                                ...
                                <li><strong>Reporting:</strong> Use <Link href="/contact">form</Link> or <a href="https://admin.ilhrf.org/content-moderation" target="_blank" rel="noopener noreferrer">report button</a>; 24-hour review.</li>
                ...
                <section className="mt-10 animate-fade-in-up animate-delay-400">
                    <details open className="neu-raised rounded-2xl p-4">
