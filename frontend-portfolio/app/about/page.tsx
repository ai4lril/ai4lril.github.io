...
export default function AboutPage() {
    ...
    return (
        <div className="w-full max-w-2xl md:max-w-4xl xl:max-w-6xl mx-auto py-12 md:py-16 px-4 animate-fade-in-up">
            ...
            {/* Hero / Mission */}
            <header className="relative neu-raised rounded-2xl p-6 md:p-8 border border-slate-100 animate-bounce-in xl:mr-[280px]" id="mission">
                ...
                <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3 text-center animate-fade-in-up animate-delay-400">
                    <div className="group rounded-xl neu-raised-sm py-4 px-3 hover:shadow-xl transition-all duration-300 hover:scale-105 hover:-translate-y-1">
            ...
            <section className="mt-8 neu-raised rounded-2xl p-6 md:p-8 border border-slate-100 xl:mr-[280px]" aria-labelledby="mission-snapshot">
                <div className="flex items-center gap-3 mb-4">
            ...
            {/* Research annex */}
            <section className="mt-12 neu-raised rounded-2xl p-6 md:p-8 border border-slate-100 xl:mr-[280px]" id="research-annex" aria-labelledby="research-annex-heading">
                <div className="flex items-center gap-3 mb-4">
            ...
            {/* Community faces */}
            <section className="mt-8 neu-raised rounded-2xl p-6 md:p-8 border border-slate-100 xl:mr-[280px]" id="community-faces" aria-labelledby="community-faces-heading">
                <div className="flex items-center gap-3 mb-4">
            ...
            <aside className="hidden xl:block absolute right-0 top-32 w-[260px]">
                <nav className="neu-raised rounded-xl border border-slate-100 p-3 shadow-sm min-w-[200px]">
            ...
            {/* What we collect */}
            <section className="mt-12 neu-raised rounded-2xl p-6 md:p-8 border border-slate-100 xl:mr-[280px]" id="what-we-collect">
                ...
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="neu-raised rounded-2xl p-4 transition hover:shadow-lg hover:-translate-y-0.5">
            ...
            {/* How it works */}
            <section className="mt-12 neu-raised rounded-2xl p-6 md:p-8 border border-slate-100 xl:mr-[280px]" id="how-it-works">
                ...
                <div className="mt-6 relative pl-8 before:content-[''] before:absolute before:top-4 before:bottom-4 before:left-3 before:w-0.5 before:bg-linear-to-b from-indigo-400 via-purple-400 to-pink-400">
                    {[
                        ...
                        <div key={step.title} className="relative mb-6 last:mb-0">
                            ...
                            <div className="neu-raised-sm rounded-2xl p-4 hover:shadow-md transition">
            ...
            {/* Community impact */}
            <section className="mt-12 neu-raised rounded-2xl p-6 md:p-8 border border-slate-100 xl:mr-[280px]" id="community-impact">
                <h2 className="text-xl font-semibold text-slate-800">
                    <span className="inline-block relative pb-1">
                        Community impact
                        <span className="absolute -bottom-0.5 left-0 w-full h-[2px] bg-linear-to-r from-indigo-500 to-purple-500"></span>
                ...
                <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                    <div className="rounded-lg neu-raised-sm py-3 px-2">
            ...
            {/* Roadmap */}
            <section className="mt-12 neu-raised rounded-2xl p-6 md:p-8 border border-slate-100 xl:mr-[280px]" id="roadmap">
                <h2 className="text-xl font-semibold text-slate-800">
                    <span className="inline-block relative pb-1">
                        Roadmap
                        <span className="absolute -bottom-0.5 left-0 w-full h-[2px] bg-linear-to-r from-indigo-500 to-purple-500"></span>
                ...
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="neu-raised rounded-2xl p-4 border border-slate-200">
            ...
            {/* Get involved */}
            <section className="mt-12 neu-raised rounded-2xl p-6 md:p-8 border border-slate-100 xl:mr-[280px]" id="get-involved">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                    <div className="md:col-span-2">
                        ...
                        <div className="mt-4 flex flex-wrap gap-3 animate-fade-in-up animate-delay-300">
                            ...
                            <a href={`${process.env.NEXT_PUBLIC_CROWDSOURCING_URL || 'https://crowdsourcing.ilhrf.org'}/speak`} className="group inline-flex neu-btn-secondary text-sm font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 active:scale-95 items-center gap-2 min-h-[44px]">
                                <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <aside className="neu-raised rounded-2xl p-6">
            ...
            <section className="mt-12 xl:mr-[280px]" id="contributors">
                <div className="relative">
                    ...
                    <div className="neu-raised rounded-3xl p-8 md:p-12 border border-slate-100 relative overflow-hidden">
                    ...
                    <div className="mt-8 space-y-4">
                        {contributors.map((c) => (
                            <details key={c.name} className="neu-raised rounded-2xl border border-slate-100 shadow-md hover:shadow-lg transition-all">
                    ...
                    <div className="mt-12 text-center">
                        <div className="neu-raised rounded-2xl p-8 border border-slate-100 max-w-md mx-auto">
            ...
            {/* FAQ */}
            <section className="mt-12 neu-raised rounded-2xl p-6 md:p-8 border border-slate-100 xl:mr-[280px]" id="faq">
                <h2 className="text-xl font-semibold text-slate-800">
                    <span className="inline-block relative pb-1">
                ...
                <div className="mt-4 space-y-3 animate-fade-in-up animate-delay-400">
                    <details className="group rounded-xl neu-raised-sm p-4 hover:shadow-md transition-all duration-300">
            ...
            <a href="#mission" className="group fixed bottom-6 xl:right-[280px] right-6 neu-btn-secondary rounded-full px-4 py-3 text-sm transition-all duration-300 hover:scale-110 active:scale-95 flex items-center gap-2 animate-bounce-in min-h-[44px]">
