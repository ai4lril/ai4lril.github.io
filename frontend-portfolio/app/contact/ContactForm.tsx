            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-4 neu-pressed rounded-xl focus:ring-2 focus:ring-blue-500 transition-colors ${showError("name") ? "ring-2 ring-red-500" : ""
                                }`}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-4 neu-pressed rounded-xl focus:ring-2 focus:ring-blue-500 transition-colors ${showError("email") ? "ring-2 ring-red-500" : ""
                                }`}
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows={6}
                        className={`w-full px-4 py-4 neu-pressed rounded-xl focus:ring-2 focus:ring-blue-500 transition-colors resize-vertical ${showError("message") ? "ring-2 ring-red-500" : ""
                            }`}
                ...
                <div className="flex justify-end">
                    <button
                        type="submit"
                        disabled={submitting}
                        className="px-8 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 disabled:from-indigo-400 disabled:to-indigo-400 text-white font-semibold rounded-xl shadow-md shadow-indigo-500/20 transition-colors duration-200 flex items-center gap-2 disabled:cursor-not-allowed min-h-[44px]"
                    >
                        {submitting && (
