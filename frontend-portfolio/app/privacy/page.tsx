        ...
        <div className="container mx-auto py-12 px-4 max-w-3xl animate-fade-in-up">
            <div className="neu-raised rounded-2xl p-6 md:p-8 animate-bounce-in">
                ...
                <section className="mt-8 space-y-4 text-slate-700 leading-relaxed">
                    ...
                    <div className="mt-6 neu-raised rounded-2xl p-6">
                ...
                <details className="mt-8 neu-raised rounded-xl p-4">
                ...
                <details className="neu-raised rounded-xl p-4 mt-4">
                ...
                <details className="mt-8 neu-raised rounded-xl p-4">
                    ...
                    <div className="mt-4 space-y-3">
                        ...
                        <ul className="space-y-1 text-slate-700">
                            ...
                            <li><strong>Documentation:</strong> <a href="https://crowdsourcing.ilhrf.org/docs" target="_blank" rel="noopener noreferrer">Full API Privacy Guide</a> (includes rate limits, error handling).</li>
                        </ul>
