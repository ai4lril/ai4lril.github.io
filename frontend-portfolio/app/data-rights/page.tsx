            ...
            <div className="neu-raised rounded-2xl p-6 md:p-8 animate-bounce-in">
                    ...
                    <div className="mt-4 space-y-4">
                        <div className="bg-teal-50 border border-teal-200 rounded-lg p-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between p-3 neu-raised rounded-xl">
                                    <div>
                ...
                <section className="mt-10">
                    ...
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        {[
                            ...
                            <div key={item.title} className="neu-raised rounded-2xl p-4">
                ...
                <section className="mt-10 animate-fade-in-up animate-delay-500">
                    ...
                    <div className="mt-4 space-y-4">
                        ...
                        <div className="mt-4 neu-raised rounded-2xl p-4">
