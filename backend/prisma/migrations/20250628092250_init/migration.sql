...
CREATE TABLE "users" (
    ...
    "current_residence_pincode" TEXT,
    "birth_place_pincode" TEXT,
    ...
    "birthplace_pincode" TEXT,
    "birthplace_village_city" TEXT,
    "current_residence_village_city" TEXT,
    "workplace_college_pincode" TEXT,
    "workplace_college_city" TEXT,
    "mother_tongue" TEXT,
    "education" TEXT,
    "occupation" TEXT,
...
CREATE TABLE "speech_recordings" (
    ...
    "file_size" INTEGER,
    "media_type" TEXT NOT NULL DEFAULT 'audio' NOT NULL,
    "is_validated" BOOLEAN NOT NULL DEFAULT false,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
