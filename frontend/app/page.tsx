...
export default function HomePage() {
    return (
        <div className="min-h-screen">
                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="text-center mb-12">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animate-delay-400">
                            ...
                            <Link
                                href="/about"
                                className="px-8 py-4 bg-white hover:bg-gray-50 text-indigo-600 font-semibold rounded-full border-2 border-indigo-600 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                            >
                                Learn More
                            </Link>
                        </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 animate-fade-in-up animate-delay-600">
                        <div className="glass rounded-2xl p-6 border border-slate-100 text-center hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            {/* Features Section */}
            <section className="w-full py-16 md:py-24 px-4 bg-white/50">
                <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <Link
                            href="/speak"
                            className="card rounded-2xl p-6 hover:shadow-xl transition-all duration-300 hover:scale-105 group"
                        >
            ...
            <section className="w-full py-16 md:py-24 px-4">
                <div className="container mx-auto max-w-4xl">
                    <div className="glass rounded-2xl p-8 md:p-12 text-center border border-slate-100">
