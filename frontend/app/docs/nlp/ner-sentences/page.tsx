    ...
    return (
        <div className="prose prose-slate max-w-none">
            ...
            >
                ...
                <h2>Endpoint</h2>
                <CodeBlock language="http">GET /api/ner-sentences</CodeBlock>
                    ...
                    examples={[
                        {
                            language: 'bash',
                            label: 'cURL',
                            code: `curl -X GET "https://api.example.com/api/ner-sentences?languageCode=en"`,
                        },
                        {
                            language: 'javascript',
                            label: 'JavaScript',
                            code: `const response = await fetch('https://api.example.com/api/ner-sentences?languageCode=en');
...
response = requests.get(
    'https://api.example.com/api/ner-sentences',
