...
**Voice Data Collection Platform** — Comparative cloud cost analysis across AWS, GCP, Azure, and Oracle Cloud.
...
| **PostgreSQL**        | Primary database                      | 2 vCPU, 4 GB RAM, 50 GB | 4 vCPU, 16 GB RAM, 100 GB |
...
| **PostgreSQL**    | $37–90        | $35–85        | $25–80        | $30–75        |
...
| PostgreSQL (2 vCPU, 50 GB)        | $55      | $50      | $45      | $45      |
...
| PostgreSQL (4 vCPU, 100 GB)       | $120     | $110     | $100     | $95      |
...
- **Services:** EC2, RDS PostgreSQL, ElastiCache Redis, S3, Application Load Balancer.
...
- **Services:** Compute Engine / Cloud Run, Cloud SQL, Memorystore Redis, Cloud Storage, Load Balancing.
...
- **Services:** Virtual Machines / App Service, Azure Database for PostgreSQL, Azure Cache for Redis, Blob Storage, Load Balancer.
