...
- **Database:** Connection pooling, read replicas, partitioning (see SCALABILITY_ANALYSIS.md)
- **Storage:** MinIO distributed mode or S3 at scale
- **Target:** 7,100+ languages, ~710K–7.1M daily uploads (see SCALABILITY_ANALYSIS.md)
...
- `SCALABILITY_ANALYSIS.md` — Scale requirements and queue/storage/DB considerations
- `GAP_ANALYSIS.md` — Feature gaps and priorities
- `backend/README.md` — Backend API details
- `frontend/README.md` — Frontend setup

---

*Built for linguistic diversity and AI research.*
