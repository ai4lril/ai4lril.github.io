...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-(--neu-bg) flex items-center justify-center neu-flat">
  ...
  return (
    <div className="min-h-screen bg-(--neu-bg) flex pb-20 lg:pb-0">
      {/* Admin Navbar */}
      <AdminNavbar />
      ...
      <div className="flex-1 lg:ml-0">
        {/* Top bar */}
        <div className="sticky top-0 z-10 neu-flat border-b border-gray-200/50">
          <div className="flex items-center justify-between h-16 px-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="px-2 py-1 text-xs rounded-full bg-indigo-100/90 text-indigo-800 border border-indigo-200/50">
                {user.role}
              </div>
              <div className="px-2 py-1 text-xs rounded-full bg-emerald-100/90 text-emerald-800 border border-emerald-200/50">
                Session Active
              </div>
            </div>
          </div>
