    ...
    <AdminLayout>
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Filters */}
          <div className="neu-raised rounded-lg mb-6">
            <div className="px-4 py-5 sm:p-6">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="flex items-center space-x-2">
                  <button className="flex-1 inline-flex items-center justify-center px-3 py-2 neu-btn-secondary text-sm leading-4 font-medium rounded-xl">
          ...
          {/* Audit Logs */}
          <div className="neu-raised rounded-lg mt-8">
            <div className="px-6 py-4 border-b border-gray-200">
