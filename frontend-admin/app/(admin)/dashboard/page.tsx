...
export default function AdminDashboard() {
    ...
    const StatCard = ({ title, value, subtitle, icon: Icon, color, trend }: {
        ...
        <div className={`neu-raised overflow-hidden rounded-lg border-l-4 ${color} hover:shadow-lg transition-shadow`}>
            <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="flex items-center space-x-3">
                            <button
                                onClick={refreshData}
                                disabled={refreshing}
                                className="inline-flex items-center px-4 py-2 neu-btn-secondary text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50"
                            >
                    ...
                    {activeTab === 'overview' && (
                        <>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                                {/* User Growth Chart */}
                                <div className="neu-raised p-6 rounded-lg">
