        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-2 neu-btn-secondary rounded-xl text-sm font-medium disabled:opacity-50"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {health && Object.entries(health.components).map(([component, status]) => (
              <div key={component} className="neu-raised overflow-hidden rounded-lg">
                <div className="p-5">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
