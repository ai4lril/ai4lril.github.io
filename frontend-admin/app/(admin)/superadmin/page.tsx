    ...
    <AdminLayout>
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="neu-raised rounded-lg mb-8">
            ...
            <div className="px-6 py-6">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <button
                  ...
                  className="flex items-center justify-center px-4 py-3 neu-btn-secondary rounded-xl text-sm font-medium"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center px-4 py-3 bg-red-50/90 hover:bg-red-100 text-red-600 border border-red-200/60 rounded-xl text-sm font-medium"
                >
          ...
          {/* Data Export & Backup */}
          <div className="neu-raised rounded-lg">
            <div className="px-6 py-4 border-b border-gray-200">
                ...
                <div className="mt-3">
                  ...
                  <div className="flex items-center justify-end space-x-3 mt-6">
                    <button
                      ...
                      className="px-4 py-2 text-sm font-medium neu-btn-secondary rounded-xl"
                    >
                      Cancel
                    </button>
                    <button
